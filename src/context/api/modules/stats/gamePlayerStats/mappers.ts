...
import type { GamePlayerStats, GamePlayerStatsSupabase } from "./types.js"

export const mapGamePlayerStatsToSupabase = (stats: GamePlayerStats): GamePlayerStatsSupabase => ({
  game_feb_id: stats.gameFebId,
  team_feb_id: stats.teamFebId,
  player_feb_id: stats.playerFebId,
  local: stats.local,
  win: stats.win,
  starter_five: stats.starterFive,
...
export const mapGamePlayerStatsFromSupabase = (stats: GamePlayerStatsSupabase): GamePlayerStats => ({
  gameFebId: stats.game_feb_id,
  teamFebId: stats.team_feb_id,
  playerFebId: stats.player_feb_id,
  local: stats.local,
  win: stats.win,
  starterFive: stats.starter_five,
  jerseyNumber: stats.jersey_number,
  name: stats.name,
  minutes: stats.minutes,
  points: stats.points,
  twoPoints: {
